...
public class Galois {
    ...
    public static native void galois_region_xor(           ByteBuffer r1,         /* Region 1 */
                                      ByteBuffer r2,         /* Region 2 */
                                      ByteBuffer r3,         /* Sum region (r3 = r1 ^ r2) -- can be r1 or r2 */
...
/* These multiply regions in w=8, w=16 and w=32.  They are much faster
   than calling galois_single_multiply.  The regions must be long word aligned. */
    ...
    public static native void galois_w08_region_multiply(ByteBuffer region,       /* Region to multiply */
                                    int multby,       /* Number to multiply by */
                                    int nbytes,       /* Number of bytes in region */
                                    ByteBuffer r2,         /* If r2 != NULL, products go here.
                                                       Otherwise region is overwritten */
                                    boolean add);         /* If (r2 != NULL && add) the produce is XOR'd with r2 */

    public static native void galois_w16_region_multiply(ByteBuffer region,       /* Region to multiply */
                                    int multby,       /* Number to multiply by */
                                    int nbytes,       /* Number of bytes in region */
                                    ByteBuffer r2,         /* If r2 != NULL, products go here.
                                                       Otherwise region is overwritten */
    ...
    public static native void galois_w32_region_multiply(ByteBuffer region,       /* Region to multiply */
                                    int multby,       /* Number to multiply by */
                                    int nbytes,       /* Number of bytes in region */
                                    ByteBuffer r2,         /* If r2 != NULL, products go here.
                                                       Otherwise region is overwritten */
