...
#include <jni.h>
/* Header for class cn_ctyun_ec_jni_Jerasure */

#ifndef _Included_cn_ctyun_ec_jni_Jerasure
#define _Included_cn_ctyun_ec_jni_Jerasure
#ifdef __cplusplus
extern "C" {
#endif
/*
 ...
 * Signature: (IIII[Ljava/nio/ByteBuffer;[Ljava/nio/ByteBuffer;I)V
 */
JNIEXPORT void JNICALL Java_cn_ctyun_ec_jni_Jerasure_my_1jerasure_1matrix_1encode
  (JNIEnv *, jclass, jint, jint, jint, jlong, jobjectArray, jobjectArray, jint);


/*
 * Class:     cn_ctyun_ec_jni_Jerasure
 * Method:    my_jerasure_matrix_decode
 * Signature: (IIIIZ[I[Ljava/nio/ByteBuffer;[Ljava/nio/ByteBuffer;I)Z
 */
JNIEXPORT jboolean JNICALL Java_cn_ctyun_ec_jni_Jerasure_my_1jerasure_1matrix_1decode
  (JNIEnv *, jclass, jint, jint, jint, jlong, jboolean, jintArray, jobjectArray, jobjectArray, jint);
